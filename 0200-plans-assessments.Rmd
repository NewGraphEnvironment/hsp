...
Check in procedures are set up so that someone is watching our back in the field. Call, text or in reach emergency contact to keep them updated on your plan ([emergency contact list](https://github.com/NewGraphEnvironment/onboarding/blob/main/data/template_contacts_safetylog.csv)). This information is kept in Field Safety Plans and there are set procedures about what the check in person is to do if they don't get confirmation that the field crews are home safe.  
